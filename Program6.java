class Core2Web{
	public static void main(String[] args){
		...
		if(num1>num2 && num1>num3)
			...
			System.out.println(num1+ " is greater than "+num2+" but equal to "+num3);
		else if(num2>num3 && num2==num1)
			System.out.println(num2+ " is greater than "+num3+" but equal to "+num1);
		else if(num3>num1 && num3==num2)
			System.out.println(num3+ " is greater than "+num1+" but equal to "+num2);
		else
